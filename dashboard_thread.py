...
# 📁 Load Data
# ============================
df = pd.read_excel(r"C:\Users\karimudin\OneDrive - Zi.Care\Documents - Data Team - Zi.Care\General\#005-User Story DevOps\Recap Top Gun 20250227.xlsx")
...
if 'Tanggal Open' in df_tampil.columns:
    ...
    # Buat kolom Bulan
    df_tampil['Bulan'] = df_tampil['Tanggal Open'].dt.strftime('%Y-%m')  # contoh: 2025-04
...
# ============================
    ...
    df_tampil['Minggu'] = df_tampil['Tanggal Open'].dt.strftime('%Y-W%U')  # contoh: 2025-W14
